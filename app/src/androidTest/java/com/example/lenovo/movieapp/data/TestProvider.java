...
public class TestProvider extends AndroidTestCase {
    ...
    public void testGetType() {
        ...
        // vnd.android.cursor.dir/com.example.lenovo.movieapp/movie
    ...
    public void testUpdatemovie() {
        ...
        updatedValues.put(MovieEntry.COLUMN_VOTE_AVERAGE,5);
    ...
    static ContentValues[] createBulkInsertMovieValues(long movieRowId) {
        ...
        for ( int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++ ) {
            ...
            MovieValues.put(MovieContract.MovieEntry.COLUMN_VOTE_AVERAGE,8.04);
            MovieValues.put(MovieContract.MovieEntry.COLUMN_MOVIE_POSTER, "/fYzpM9GmpBlIC893fNjoWCwE24H.jpg");
            MovieValues.put(MovieContract.MovieEntry.COLUMN_RELEASE_DATE, TestUtilities.TEST_DATE);
            MovieValues.put(MovieContract.MovieEntry.COLUMN_OVERVIEW,"Thirty years after defeating the Galactic Empire, Han Solo and his allies face a new threat from the evil Kylo Ren and his army of Stormtroopers.");
